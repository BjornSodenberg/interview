...
public class CommentsActivity extends AppCompatActivity {
    ...
    private CommentRecyclerViewAdapter commentsRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blog_post_id = getIntent().getStringExtra("post_id");
        ...
        commentsRecyclerAdapter = new CommentRecyclerViewAdapter(commentsList);
